var on_switch = function()
{
    ...
    variable_instance_set(obj_fmod_studio, bankRef, fmod_studio_system_load_bank_file(fmod_path_bundle(bank), FMOD_STUDIO_LOAD_BANK.NONBLOCKING));
    obj_fmod_studio.levelStructBank = fmod_studio_system_load_bank_file(fmod_path_bundle(bnk_levelstruct), FMOD_STUDIO_LOAD_BANK.NONBLOCKING);
