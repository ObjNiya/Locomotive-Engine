...
function AnimcurveValue(curve_struct_or_id, channel_name_or_index, duration, duration_units = time_source_units_frames) constructor 
{
    animcurve = -1;
    animcurve_channel = -1;
    ...
    if (!instance_exists(obj_animcurve_value_manager))
        instance_create_depth(0, 0, 999, obj_animcurve_value_manager);
    
    array_push(obj_animcurve_value_manager.animcurve_values, self);
}