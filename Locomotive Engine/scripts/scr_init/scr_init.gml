...
function InitGlobals()
{
    with (global)
    {
        ...
        fntSign = font_add_sprite_ext(spr_fnt_sign, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!,.:0123456789'?-", true, 2);
        fntBig = font_add_sprite_ext(spr_fnt_big, "ABCDEFGHIJKLMNÑOPQRSTUVWXYZ!¿?.:1234567890ÁÉÍÓÚ", 1, 0);
