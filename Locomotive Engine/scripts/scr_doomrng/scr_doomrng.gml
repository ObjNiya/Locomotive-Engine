...
global.rngIndexVisuals = 0;


/**
 * Advances the RNG Index for Visuals and returns the value of the index it's on.
 */
function DoomRngVisuals()
{
    global.rngIndexVisuals = (global.rngIndexVisuals + 1) & 255;
    return global.__RngTable__[global.rngIndexVisuals];
}


/**
 * Advances the RNG Index for Gameplay and returns the value of the index it's on.
 */
function DoomRngGameplay()
{
    global.rngIndexGameplay = (global.rngIndexGameplay + 1) & 255;
    return global.__RngTable__[global.rngIndexGameplay];
}


/**
 * Resets the RNG Index for Gameplay and Visuals back to the start.
 */
function DoomRngReset()
{
    global.rngIndexVisuals = 0;
    global.rngIndexGameplay = 0;
}
