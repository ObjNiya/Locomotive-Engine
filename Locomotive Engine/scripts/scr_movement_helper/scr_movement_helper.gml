 ...
 * ```acceleration``` can be used to determine by how many pixels your object will reach it's maximum speed.
 * ```vertical_acceleration``` just like ```acceleration```, but reserved for the Y axis.
